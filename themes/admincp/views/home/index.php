                                ...
                                <div class="control-group immobilier-admin-search">
                                    <div class="controls">
                                        <div class="input-append">
                                            <input title="Recherche ref ex:btk192762" name="property_id" placeholder="BTK<?php echo $model->id; ?>" type="text" size="16" id="appendedInputButtons" class="input-xlarge text-tip">
            ...
            <div class="widget-content">
                <div class="widget-box">
                    <ul class="immobilier-ul" style="margin-top:10px;">
                        ...
                        <?php endif; ?>
                        <li><a href="<?php echo PIUrl::createUrl('/module/aquereurs/?id=' . $model->id); ?>" target="_blank"><span class="color-icons arrow_right_co"></span> Consulter les clients acquéreurs <strong style="color:red">(<span id="countAllListCustomer" rel="<?php echo $model->id; ?>">...</span>)</strong></a></li>
