                    ...
                    <div class="box-tab">
                        <div class="tabbable"> 
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li>
<!--                                    <form id="activeProperty" action="<?php //echo PIUrl::createUrl('/home/activeProperty', array('id' => $model->id));           ?>" method="POST">
                                        <input type="hidden" name="Active" value="<?php //echo $model->is_validate == 0 ? 1 : 0;           ?>"/>
                                        <button type="submit" class="btn <?php //echo $model->is_validate == 1 ? 'btn-success' : 'btn-info';           ?>"><?php //echo $model->is_validate == 1 ? 'Activer' : 'Désactiver';           ?></button>
                                    </form>-->
                                </li>
                            </ul>
