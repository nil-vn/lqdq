    ...
    <form method="POST" id="saveCategoryForm" action="<?php echo PIUrl::createUrl('/home/saveCategory/', array('id' => $model->id)); ?>">
        <fieldset>
            <div class="control-group">
                <label style="width:100%;text-align:center" class="control-label">
                    <?php
                    $listCategory = "";
                    if (!empty($myCategory))
                ...
                <div class="span6 container-span" id="container-category" style="display:none" data-type="hidden">
                    <blockquote>
        ...
        <fieldset>
            ...
            <?php if (in_array('qualite', $arrFieldName)): ?>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="select-control" name="<?php echo array_search('qualite', $arrFieldName); ?>_qualite" id="property_qualite">
                            <?php
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select name="pays" id="property_pays" class="select-control">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select class="select-control" name="Property[villes]" id="property_villes" class="text-tip isRequired" title="Ville">
                        <?php
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php if ($field->type == 1): ?>
                                ...
                                <select name="<?php echo $field->id . "_" . $field->htmlvar_name; ?>" id="property_<?php echo str_replace('[]', '', $field->htmlvar_name); ?>" class="text-tip <?php echo $class; ?> select-control" title="<?php echo $field->field_name; ?>">
                                    <?php
                    ...
                    <form action="<?php echo PIUrl::createUrl('/home/saveEnegy'); ?>" class="form-horizontal" id="saveEnegyForm">
                        ...
                        <fieldset>
                            <!-- <div class="input-append date" id="datepicker" data-date="<?php echo date(Yii::app()->params['date'], time()); ?>" data-date-format="dd/mm/yyyy"> -->
                                <div class="control-group date" id="datepicker" data-date="<?php echo date(Yii::app()->params['date'], time()); ?>" data-date-format="dd/mm/yyyy" data-date-end-date="<?php echo date('d/m/Y',time());?>">
                                    <label class="control-label"> Date de réalisation du diagnostic </label>
                                    <div class="controls">
                                        <div class="input-append input-date">
                                            <!-- style="margin-left: 185px;width: 183px;"-->
                                            <input name="WpEnegy[dpeDate]" size="16" type="text" value="<?php echo ($model->enegy == null || $model->enegy->dpeDate == '0000-00-00') ? '' : date(Yii::app()->params['date'], strtotime($model->enegy->dpeDate)); ?>">
