...
<form method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>" name="form" onSubmit='return verifier()'>
...
<tr>
    <td>        
            ...
            <div class = "raison" style="padding-left:200px; font-size:14px;">
