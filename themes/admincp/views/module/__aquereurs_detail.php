		...
		<div class="container top-profile">
			<div class="div-property-detail">
				<div class="div-property-detail-left">
					<h2>BTK<?php echo $listCustomer->id; /*echo $listCustomer->property->id;*/?> <span><?php echo $paymentPackage;?></span></h2>
...
//						}
					...
					<p><?php /*echo $listCustomer->property->getMetaValue('prix') != ''? number_format($listCustomer->property->getMetaValue('prix')) : '';*/
                                        //echo WpPostProperty::model()->getMetaValue('prix') != ''? number_format($listCustomer->getMetaValue('prix')) : '';€
                                        ?> </p> 
				</div>
		...
		<div class="container content-profile">
			...
			<div class="form_show">
			<form class="form-horizontal" id="update_acquereursForm" name="myForm" action="<?php echo PIUrl::createUrl('/module/UpdateAquereurs',array('id'=>$listCustomer->id));?>">
			<fieldset>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<?php if(strlen($listCustomer->customer_tel) > 1):?>
							...
							<span class="help-inline"><a rel="<?php echo trim($listCustomer->customer_tel);?>" id="WpListCustomer_customer_tel_link" target="_blank" href="<?php echo $url;?>"><img src="<?php echo Yii::app()->theme->baseUrl.'/img/google.gif'?>"/></a>&nbsp;<?php echo $listCustomer->customer_tel;?></span>
							<div class="cls"></div>
						<?php endif;?>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						...
						<?php if(strlen($listCustomer->customer_phone) > 1):?>
							...
							<span class="help-inline"><a rel="<?php echo trim($listCustomer->customer_phone);?>" id="WpListCustomer_customer_phone_link" target="_blank" href="<?php echo $url;?>"><img src="<?php echo Yii::app()->theme->baseUrl.'/img/google.gif'?>"/></a>&nbsp;<?php echo $listCustomer->customer_phone;?></span>
							<div class="cls"></div>
						<?php endif;?>
					</div>
				</div>
				...
				<div class="span12">
					<button  type="submit" value="" class="btn btn-click-Envoyer">
						<span class="color-icons email_open_co"></span>Envoyer
					</button>
					<?php if(isset($_GET['attente']) && $_GET['attente'] == 1):?>
		
					<?php else:?>
					<button  type="submit" value="" class="btn btn-click-Attente">
						<span class="color-icons alarm_co"></span>Attente
					</button>
					<?php endif;?>
					<button  type="submit" value="" class="btn btn-click-Supprimer">
					...
					<button type="submit" rel="<?php echo $listCustomer->id;?>" type="button" value="" class="btn btn-Blacklister">
			...
			<div id="ProposerBlacklistForm" style="display:none;margin-top:10px;border-top: 2px dashed #808080;padding-top:10px">
				...
				<input type="hidden" name="post_property_id" value="<?php echo $listCustomer->id; /*$listCustomer->property->id;*/?>"/>
					<fieldset>
						<div class="control-group">
						...
						<button  type="submit" value="" class="btn btn-click-blacklist">Valider</button>
...
<script>
	$(document).ready(function(){
		...
		if($("#WpListCustomer_customer_tel").length || $("#WpListCustomer_customer_phone").length){
