...
/*$(document).ready(function() {
    $(".smsListe").fancybox({
        ...
        beforeLoad: function() {
            ...
            this.href = webroot + "/module/smsListe/" + id;
        },
//        afterClose: function() {
...
$(document).ready(function() {
    $('.premiumPaypal').click(function(){
        var id = $(this).attr('ref');
        getRunAction(id);
    });
	$('.menuCountAcq').click(function(){
        var id = $(this).attr('href');
        runFancyboxAcq(id);
    });
});
function runFancyboxAcq(id){
	$(".menuCountAcq").fancybox({
        maxWidth: 1290,
        maxHeight: 550,
        fitToView: false,
        width: '1290',
...
function getRunAction(id){
    $(".premiumPaypal").fancybox({
        maxWidth: 1290,
        maxHeight: 550,
        fitToView: false,
        width: '1290',
        ...
        closeEffect: 'none',
        type: 'ajax',
        href:  webroot + "/module/paypalResilier/id/" + id,
        afterClose: function() {
           window.location.reload();
        },
    });
